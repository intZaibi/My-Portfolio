      ...
      <div className="padding-part" style={{ padding: "0px" }}>
        ...
        >
          <img
            src={
              props.image ||
              "https://cdn.prod.website-files.com/64fa383e971fe0586c36d973/666abf09392b7473a554f13e_Engine%20display.webp"
            }
            alt="Engine"
        ...
        <div className="projects-card-heading" style={{ marginTop: "5px" }}>
          <div aria-label="project-link" className={`tag-title ${props.anime}`}>
            ...
            <div className="projects-card-title">
              {" "}
              {props.Project || "Featured Project"}{" "}
            </div>
          </div>
          <Link className="circle-60-arrow" to={props.link}>
